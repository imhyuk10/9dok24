...
YouTube の登録チャンネルを別の Google アカウントへ、素早く・選択的に・内蔵の API クォータゲージを見ながら移行できる Electron デスクトップアプリです。
...
- **API クォータゲージ** — アプリが記録した YouTube Data API の 1 日あたり挿入数を、上限 200 回に対して表示します。
